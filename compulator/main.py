...
def help() -> None:
    ...
    print("     (Notice the parameters in the formula are encased in curly braces)")
    ...
    print("- make sure you encapsulate formulas/constants in brackets")
    print("     - ex. 'a + b' should be '[a] + [b]'")
    print("- make sure you encapsulate parameters in curly braces")
    print("     -ex. foo(a, b) = {a} + {b}")
